...
public class Tetrahedron
{
	...
	public Tetrahedron(float size)
	{
		...
		mediumPos = TCSUtils.getCoordinatesForMetrics(pi/2, pi/2 - deg110, magnitude);
		longPos = TCSUtils.getCoordinatesForMetrics(pi/2 - circleThird, pi/2 - deg110, magnitude);
		shortPos = TCSUtils.getCoordinatesForMetrics(pi/2 + circleThird, pi/2 - deg110, magnitude);
		uvPos = TCSUtils.getCoordinatesForMetrics(0, pi/2, magnitude);
